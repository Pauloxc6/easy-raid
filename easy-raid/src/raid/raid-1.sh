...
function raid0() {
    ...
    if [[ $hmd -eq 2 ]];then
        ...
        echo -e "\e[0m"
        mdadm --create --verbose /dev/$nameraid --level=1 --raid-devices=2 $dev1 $dev2
        ...
        echo -e "\e[30;1m[*] Creating the raid [*]"
        echo -e "\e[0m"
        mdadm --create --verbose /dev/$nameraid --level=1 --raid-devices=3 $dev1 $dev2 $dev3
        ...
        echo -e "\e[30;1m[*] Creating the raid [*]"
        echo -e "\e[0m"
        mdadm --create --verbose /dev/$nameraid --level=1 --raid-devices=4 $dev1 $dev2 $dev3 $dev4
        ...
        echo -e "\e[30;1m[*] Creating the raid [*]"
        echo -e "\e[0m"
        mdadm --create --verbose /dev/$nameraid --level=1 --raid-devices=5 $dev1 $dev2 $dev3 $dev4 $dev5
        ...
        echo -e "\e[30;1m[*] Creating the raid [*]"
        echo -e "\e[0m"
        mdadm --create --verbose /dev/$nameraid --level=1 --raid-devices=6 $dev1 $dev2 $dev3 $dev4 $dev5 $dev6
        ...
        echo -e "\e[30;1m[*] Creating the raid [*]"
        echo -e "\e[0m"
        mdadm --create --verbose /dev/$nameraid --level=1 --raid-devices=7 $dev1 $dev2 $dev3 $dev4 $dev5 $dev6 $dev7
        ...
        echo -e "\e[30;1m[*] Creating the raid [*]"
        echo -e "\e[0m"
        mdadm --create --verbose /dev/$nameraid --level=1 --raid-devices=8 $dev1 $dev2 $dev3 $dev4 $dev5 $dev6 $dev7 $dev8
